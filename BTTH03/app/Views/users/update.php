    ...
    <form class="row g-3 needs-validation" novalidate method="POST">
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="validationCustom01" name="title"
                   value="<?php echo $articles[0]->getTitle(); ?>" required>
        </div>
        <div class="col-md-4">
            <label for="validationCustom02" class="form-label">Summary</label>
            <input type="text" class="form-control" id="validationCustom02" name="summary"
                   value="<?php echo $articles[0]->getSummary(); ?>" required>
        </div>
        <div class="col-md-4">
            <label for="validationCustomUsername" class="form-label">Content</label>
            <div class="input-group has-validation">
                <input type="text" class="form-control" id="validationCustomUsername" name="content"
                       value="<?php echo $articles[0]->getContent(); ?>" aria-describedby="inputGroupPrepend" required>
            </div>
        </div>
        <div class="col-md-6">
